...
function ChatPanel({ messages, onSendMessage, onUsePrompt, modules, moduleStatus, moduleMemory }) {
    ...
    <aside className="chat-panel panel">
      ...
      <div className="chat-context">
        ...
        {savedModules.length === 0 ? (
          <p className="chat-context-empty">저장된 모듈이 없습니다. 작업 중인 모듈을 저장하면 여기에 표시됩니다.</p>
        ) : (
